...
from joy_status import IpegaStatus, XBoxStatus, PS3Status, PS3WiredStatus, PS3DummyStatus
...
def autoJoyDetect(msg):
  ...
  if len(msg.axes) == 27 and len(msg.buttons) == 19:
    ...
    AUTO_DETECTED_CLASS = PS3DummyStatus
  else:
...
class JoyManager():
  ...
  def __init__(self, plugin_package="jsk_teleop_joy"):
    ...
    elif self.controller_type == 'ps3dummy':
      self.JoyStatus = PS3DummyStatus
